...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 w-full max-w-sm mx-4 animate__animated animate__zoomIn animate__faster">
      <div class="text-center mb-6">
        <div class="w-14 h-14 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-4 animate__animated animate__pulse animate__delay-1s">
      ...
      <form @submit.prevent="handleSubmit">
        <input
          ...
          autofocus
          class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors mb-3"
        />
